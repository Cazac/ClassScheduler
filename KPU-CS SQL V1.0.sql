...
drop database KPUClassScheduler;
create database KPUClassScheduler;

-- -----Select thet database for use-----

use KPUClassScheduler;
...
create table TeacherTeachingCourses(
  CRNID varchar(12) NOT NULL,
...
insert into KPUSection(CRNID,  		SectionID, 	CourseID,   	Campus, 		RoomNo, 		SemYear,  	Season,  	KPUID,  		TimeSlot, 			DayOfWeek)
  values (			'100222001', 	'S10', 		'INFO1111',		'Surrey', 		'Cedar 2045', 	'2018',		'Summer',	100100100,		'7am - 9:50am',		'Monday'),
         (			'100222002', 	'S20', 		'INFO1111', 	'Surrey',		'Cedar 2045',	'2018',		'Summer',	100100100,		'1pm - 3:50pm',		'Friday'),
         (			'100222003', 	'S10', 		'INFO1111', 	'Cloverdale',	'Room 1020',	'2018',		'Summer',	100100101,		'1pm - 3:50pm',		'Friday'),
...
insert into TeacherTeachingCourses(KPUID,			TeachingCourseID, 	CRNID)
  values (				'100100100', 				'INFO1111', 		'100222001'),
		 (				'100100100', 				'INFO1112',			'100222002'),
		 (				'100100101', 				'INFO1113',			'100222003'),
		 (				'100100101', 				'INFO1114',			'100222005');
